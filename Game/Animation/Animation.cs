...
namespace Ceusters_Jitze_GameDevelopment.Game.Animation
{
    public class Animation
    {
        ...
        {
            Globals.SpriteBatch.Draw(_texture, pos, _sourceRectangles[_frame], Color.White, 0f, Vector2.Zero, origin, SpriteEffects.None, 1f);
        }
    }
}
